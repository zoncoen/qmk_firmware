 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |  L2  |  L1  | Alt  | Alt  | LGui |                                       | Esc  | Down |   [  |   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | App  | LGui |       | Play |Ctrl/Esc|
 *                                 ,------|------|------|       |------+--------+------.
 *                                 |      |      | VolUp|       | Next |        |      |
 *                                 |Space |Alt+  |------|       |------| Back   |Enter |
 *                                 |      |Space | VolDn|       | Prev | space  |      |
 *                                 `--------------------'       `----------------------'
 */
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        MO(2),          MO(1),        KC_LCTL,KC_LALT,KC_LGUI,
                                              ALT_T(KC_APP),       KC_LGUI,
                                                                   KC_VOLU,
                                               KC_SPC,LALT(KC_SPC),KC_VOLD,
        // right hand
             KC_6,        KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,          KC_EQL,
             TG(1),       KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,             KC_BSLS,
                          KC_H,   KC_J,   KC_K,   KC_L,   LT(MDIA, KC_SCLN),KC_QUOT,
             MEH_T(KC_NO),KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,          KC_RSFT,
                                  KC_ESC,  KC_DOWN,KC_LBRC,KC_RBRC,         KC_FN1,
             KC_MPLY,     CTL_T(KC_ESC),
             KC_MNXT,
             KC_MPRV,KC_BSPC,KC_ENT
    ),
 ...
 * |        |      |      | MsUp |      |      |      |           |      |   [  |   ]  |   {  |  }   |      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |  RESET |      |MsLeft|MsDown|MsRght|      |------|           |------| Left | Down |  Up  |Right |      |  Play  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |      |      |      |      |      |           |      |      |      | Prev | Next |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
